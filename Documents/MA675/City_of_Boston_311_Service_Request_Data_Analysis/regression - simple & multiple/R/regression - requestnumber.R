...
# multiple lm
summary(lm(Boston.Public.School ~ population + area + age.over.18 + factor(requestnum$black.african)))
summary(lm(Property.Management ~ age.over.18 + male + female + factor(requestnum$asian)))